...
📌 Project Overview
This project addresses the challenge of identifying and classifying "toxic" online comments to foster healthier digital environments. Using the Jigsaw Toxic Comment Classification dataset, I conducted a rigorous comparative study between traditional statistical methods and modern neural network architectures.
...
Baseline: Statistical models using TF-IDF vectorization (e.g., Logistic Regression or Naive Bayes).

Advanced: Neural paradigms using word embeddings (Word2Vec/GloVe) and sequence models (LSTM/GRU) or Transformer-based approaches.
...
Neural Superiority: Sequence models (Neural Paradigms) excel in capturing context and subtle linguistic nuances, leading to a higher ROC-AUC on multi-label classification.
...
📂 File Structure
Computational_Linguistics_Final_Project_r1077191.ipynb: Full implementation, experiment logs, and comparative analysis.

data/: Training and testing subsets from the Jigsaw dataset.

models/: (Optional) Saved model weights or serialized objects.
